# usepr Contributing Guide

Hi! I'm really excited that you are interested in contributing to usepr. Before submitting your contribution, please make sure to take a moment and read through the following guidelines:
...
- [Python](https://python.org) 3.13 or higher
...
- [DSPy](https://dspy.ai/) for AI-powered PR summary generation
...
# Run a specific test
$ uv run pytest tests/test_git.py::TestGetDefaultBranch -v
```
...
```
├── src/usepr/                       # Source code
│   ├── __init__.py
│   ├── cli/                         # CLI implementation
│   │   ├── __init__.py
│   │   └── commands/                # Command implementations
│   │       ├── __init__.py
│   │       └── generate_command.py  # PR summary generation command
│   ├── configs/                     # Configuration
│   │   ├── __init__.py
│   │   └── dspy.py                 # DSPy model configuration
│   ├── modules/                     # DSPy modules
│   │   ├── __init__.py
│   │   └── pull_request_summary_generator.py
...
│       └── github.py               # GitHub template detection
├── tests/                           # Test files
...
- Use absolute imports from the `usepr` package for local modules
...
from usepr.services.pr_summary_service import generate_summary
```
...
Thank you to all the people who have already contributed to usepr!

<a href="https://github.com/thememium/usepr/graphs/contributors"><img src="https://contrib.rocks/image?repo=thememium/usepr" /></a>
